...
class TotalPayrollEmployee
{
    ...
    public function add_total_amount_discount_institution($value)
    {
        $this->total_amount_discount_institution += $value;
    }
    ...
    public function subtract_total_amount_discount_institution($value)
    {
        $this->total_amount_discount_institution -= $value;
    }
