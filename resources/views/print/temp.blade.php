...
<head>
    ...
    <style>
        ...
        } .m-b-25{ margin-bottom: 25px; } .m-b-50{ margin-bottom: 50px; } .m-t-5{ margin-top: 5px; } .m-t-10{ margin-top: 10px; }
        .m-t-15{ margin-top: 15px; } .m-t-20{ margin-top: 20px; } .m-t-25{ margin-top: 25px; } .m-t-30{ margin-top: 30px; } .m-t-35{
        margin-top: 35px; } .m-t-50{ margin-top: 50px; } .pin-t{top: 0;} .pin-r{right: 0;} .pin-b{bottom: 0;} .pin-l{left: 0;} .pin-y{
        ...
        <div class="main-left">
            ...
            <table border=1>
                <tr>
                    ...
                    <td>
                        <span class="uppercase courier text-sm">2018/Abril</span>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <span class="uppercase courier text-sm">30</span>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <span class="uppercase courier text-sm">PAGO DE HABERES ABRIL 2018</span>
                    </td>
                </tr>
                <tr>
                    <td  class="no-border">
                    ...
                    <td>
                        <span class="uppercase courier text-sm">2345678 LP</span>
                    </td>
                    <td  class="no-border">
                        <span class="text-xxs">Nombre: </span>
                    </td>
                    <td>
                        <span class="uppercase courier text-sm">NOMBRE apellido mundo mundo mundo </span>
                    </td>
                </tr>
            </table>
            {{-- /personal-info --}}
            ...
            <table class="table-info">
                ...
                <tbody>
                    ...
                    <tr class="courier">
                        ...
                        <td class="text-right">8,50078</td>
                        <td></td>
                        <td></td>
                    </tr>
                    @for ($j = 0; $j < 5; $j++)
                        <tr class="courier">
                            <td ></td>
                            <td ></td>
                            <td class="text-right">AFP-rxv</td>
                            <td class="text-right">952.59</td>
                        </tr>
                    @endfor
                    <tr>
                        ...
                        <td class="text-right courier">8,50078</td>
                        <td class="text-xs text-left">
                            Total Descuentos:
                        </td>
                        <td class="text-right courier">952.59</td>
                    </tr>
                </tbody>
            </table>
            {{-- /amounts --}}
