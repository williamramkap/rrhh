...
<div class="doc">
    ...
    <div class="content">
        <p class="text" style="text-indent: 5em">
            Conste por el presente “Contrato Eventual de Prestación de Servicios” que suscriben por una parte la <span class="title-text">MUTUAL DE SERVICIOS AL POLICIA - MUSERPOL</span>, representado legalmente por el <span class="title-text">Sr. Cnl. DESP. Jhonny Donato Coronel Ayala con C.I. No. 2616779 L.P., en su calidad de Director General Ejecutivo de la MUSERPOL</span>, designado mediante Resolución Suprema Nº 16382 de fecha 31 de agosto de 2015, y por otra parte <span class="title-text up">{{ $contract->employee->first_name.' '.$contract->employee->second_name.' '.$contract->employee->last_name.' '.$contract->employee->mothers_last_name }} con C.I. N° {{ $contract->employee->identity_card.' '.$contract->employee->city_identity_card->shortened }} </span>, mayor de edad y hábil por derecho, con domicilio en la ciudad de La Paz, que en lo sucesivo se denominará el <span class="title-text">“CONTRATADO”</span> quienes celebran el presente contrato eventual, de acuerdo a los términos y condiciones siguientes:
        </p>
        <p>
